package com.D288.Backend_Programming.BootStrapData;

import com.D288.Backend_Programming.DAO.CustomerRepository;
import com.D288.Backend_Programming.DAO.DivisionRepository;
...
public class BootStrapData {
    ...
    public void loadInitialData() {
        ...
        if(customerRepository.count() == 1) {
            ...
            customer1.setFirstName("Steph");
            customer1.setLastName("Curry");
            ...
            customer2.setFirstName("Brock");
            customer2.setLastName("Purdy");
            ...
            customer3.setFirstName("Buster");
            customer3.setLastName("Posey");
            ...
            customer5.setFirstName("Barry");
            customer5.setLastName("Bonds");
